...
- Audio normalization has a new option ReplayGain. If your karaoke software supports ReplayGain, this is the preferred option as it does not reencode the audio file but instead only write normalization information into the header of the audio file. 
