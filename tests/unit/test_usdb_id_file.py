...
from usdb_syncer.usdb_id_file import (
    ...
    UsdbIdFileMissingOrDublicateOptionFormatError,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("dublicate_url_key.desktop", UsdbIdFileMissingOrDublicateOptionFormatError()),
        ("dublicate_url_key.url", UsdbIdFileMissingOrDublicateOptionFormatError()),
        ("dublicate_url_key.webloc", UsdbIdFileMultipleUrlsFormatError()),
