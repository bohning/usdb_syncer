...
def check_external_deps(parent: QWidget, on_success: Callable[[], Any]) -> None:
    ...
    If external dependencies (currently: ffmpeg) are available, can be
    ...
    if ffmpeg_available:
        ...
        ExternalDepsDialog(parent, ffmpeg_available, on_success).show()
...
class ExternalDepsDialog(Ui_Dialog, QDialog):
    ...
    def __init__(
        self, parent: QWidget, ffmpeg_available: bool, on_success: Callable[[], None]
    ) -> None:
